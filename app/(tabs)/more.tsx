...
import { User, MessageCircle, BookOpen, Phone, MapPin, Mail, Settings, CircleHelp as HelpCircle, Bell, Users, ChevronRight, LogOut } from 'lucide-react-native';
  ...
  return (
    <View style={styles.container}>
      <View style={styles.header}>
        ...
        <Text style={styles.headerSubtitle}>Connect and grow in faith</Text>
      </View>
